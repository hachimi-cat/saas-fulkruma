...
# latter meant this guard printed OK forever while the live pipeline (7
# continuation constructs) was never inspected at all. The 2026-07-14
# incident this script exists for happened in the pipeline it wasn't reading.
TARGETS = sorted(
